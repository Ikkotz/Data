...
plt.title("Top 10 jugadores por porcentaje de tiro")
...
plt.title("Top 10 jugadores por porcentaje de tiro de 3 puntos")
plt.xlabel("Jugador")
plt.ylabel("Porcentaje de tiro de 3 puntos")
plt.xticks(rotation=45, ha="right")
plt.tight_layout()
...
plt.xlabel("Jugador")
plt.ylabel("Puntos totales en su carrera")
...
plt.xlabel("Jugador")
plt.ylabel("Asistencias totales en su carrera")
...
plt.pie(status_counts, labels=["Inactivos", "Activos"], autopct="%1.1f%%", colors=["grey", "green"])
plt.title("Jugadores activos vs jugadores retirados")
